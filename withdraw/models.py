...
class Withdraw(models.Model):
  ...
  description = models.CharField('Descrição', max_length=191, null=True,   default=None)
  value_in_cents = MoneyField('Valor da retirada', max_digits=14, decimal_places=2, default_currency='BRL')
